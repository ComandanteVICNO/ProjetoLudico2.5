...
public class SmallEnemyHealth : MonoBehaviour
{
    ...
    IEnumerator Death()
    {
        ...
        stateAnimator.SetBool("canLunge", false);
        stateAnimator.SetBool("canCharge", false);
        stateAnimator.SetBool("wasAttacking", false);
        stateAnimator.SetBool("canRange", false);
        stateAnimator.SetBool("isDead", true);

        spriteAnimator.SetBool("isLunging", false);
